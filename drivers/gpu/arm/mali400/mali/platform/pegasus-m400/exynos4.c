...
#define MALI_GP_IRQ       IRQ_GP_3D
#define MALI_PP0_IRQ      IRQ_PP0_3D
#define MALI_PP1_IRQ      IRQ_PP1_3D
#define MALI_PP2_IRQ      IRQ_PP2_3D
#define MALI_PP3_IRQ      IRQ_PP3_3D
#define MALI_GP_MMU_IRQ   IRQ_GPMMU_3D
#define MALI_PP0_MMU_IRQ  IRQ_PPMMU0_3D
#define MALI_PP1_MMU_IRQ  IRQ_PPMMU1_3D
#define MALI_PP2_MMU_IRQ  IRQ_PPMMU2_3D
#define MALI_PP3_MMU_IRQ  IRQ_PPMMU3_3D
